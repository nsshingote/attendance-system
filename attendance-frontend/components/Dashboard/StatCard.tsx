...
export default function StatCard({ label, value, icon: Icon, tone = "brand" }: StatCardProps) {
  return (
    <div className="flex min-h-24 h-full flex-col justify-between rounded-xl border border-ink-200 bg-white p-3 shadow-card">
      <div className="flex items-center justify-between">
        <p className="min-h-8 pr-1 text-xs font-medium leading-4 text-ink-500">{label}</p>
