...
//   const [allowRowDescription, setAllowRowDescription] = useState(false);
...
//         : null;
//       const description = (subtypeConfig?.has_description || allowRowDescription)
...
//     return (
//       <div key={row.subtype_id} className="rounded-lg border border-ink-200 bg-white p-3">
//         <div className="mb-2 flex items-center justify-between gap-2">
//           <div>
//             <div className="text-sm font-medium text-ink-700">{typeName}</div>
//             <div className="text-sm text-ink-500">{subtypeName}</div>
//           </div>
...
//               </button>
//             )}
//             {row.is_default && <span className="text-xs text-ink-400">Default</span>}
//           </div>
//         </div>
...
//     const hasDynamicStructureForHistory = selectedDeptId !== null ? getSubtypesForDept(selectedDeptId).length > 0 : false;
...
//           <div key={group.date} className="overflow-hidden rounded-lg border border-ink-200 bg-white">
...
//                     <>
//                       <th className="px-4 py-2 text-xs font-medium text-ink-500 uppercase">Type</th>
//                       <th className="px-4 py-2 text-xs font-medium text-ink-500 uppercase">Subtype</th>
//                       <th className="px-4 py-2 text-xs font-medium text-ink-500 uppercase">Qty</th>
//                       <th className="px-4 py-2 text-xs font-medium text-ink-500 uppercase">Duration</th>
//                       <th className="px-4 py-2 text-xs font-medium text-ink-500 uppercase">Description</th>
//                     </>
//                   )}
//                   {!hasDynamicStructureForHistory && (
//                     <th className="px-4 py-2 text-xs font-medium text-ink-500 uppercase">Description</th>
//                   )}
//                   <th className="px-4 py-2 text-xs font-medium text-ink-500 uppercase">Action</th>
//                 </tr>
//               </thead>
...
//                       {hasDynamicStructureForHistory ? (
//                         <>
//                           <td className="px-4 py-2 text-sm text-ink-700">{getTypeName(report.subtype_id)}</td>
//                           <td className="px-4 py-2 text-sm text-ink-700">{getSubtypeName(report.subtype_id)}</td>
//                           <td className="px-4 py-2 text-sm text-ink-700">{report.quantity || "—"}</td>
//                           <td className="px-4 py-2 text-sm text-ink-700">{report.duration || "—"}</td>
//                           <td className="px-4 py-2 text-sm text-ink-700">{report.description || "—"}</td>
//                         </>
//                       ) : (
//                         <td className="px-4 py-2 text-sm text-ink-700">{report.description || "—"}</td>
//                       )}
...
//                         {canEdit ? (
//                           <button onClick={() => handleEditReport(report.attendance_date)} className="text-sm font-medium text-brand-600 hover:text-brand-700">✏️ Edit</button>
//                         ) : (
...
//         <div className="p-4">
//           {rows.length === 0 ? (
//             <p className="text-sm text-ink-500 text-center py-4">No rows added yet. Click "Add Row" to add entries.</p>
//           ) : (
...
//                     {(selectedSubtypeConfig?.has_description || allowRowDescription) ? (
//                       <div className="col-span-full space-y-2">
//                         <label className="flex items-center gap-2 text-sm font-medium text-ink-700">
//                           <input
//                             type="checkbox"
//                             checked={allowRowDescription}
//                             onChange={(e) => setAllowRowDescription(e.target.checked)}
//                             className="rounded border-ink-300 text-brand-600"
//                           />
//                           Add description for this row
//                         </label>
//                         {allowRowDescription && (
//                           <textarea
...
//                             rows={3}
//                             className="w-full rounded-lg border border-ink-200 px-3 py-2 text-sm"
//                             placeholder="Add a description for this subtype row"
//                           />
//                         )}
//                       </div>
//                     ) : null}
