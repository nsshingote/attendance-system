...
export default function LetterTemplatesViewer() {
  ...
  const handleUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    form.append("name", file.name.replace(/\.[^.]+$/, "") || "Uploaded Template");
    form.append("document_type", file.name.replace(/\.[^.]+$/, "") || "uploaded_template");
    try {
      await api.post("/employee-documents/letter-templates/upload", form, { headers: { "Content-Type": "multipart/form-data" } });
