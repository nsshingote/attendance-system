...
class Attendance(Base):
    ...
    check_in_latitude = Column(DECIMAL(10, 7), nullable=True)
    check_in_longitude = Column(DECIMAL(10, 7), nullable=True)
    check_in_accuracy = Column(DECIMAL(10, 2), nullable=True)
